 ...
 */
public class ImageActivity extends AppCompatActivity implements View.OnClickListener , IPickResult {

    private static final String TAG = "Storage#ImageActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.comm_image_storge_layout);
        ...
        Picasso.with(getApplicationContext()).load(firebaseUrl).into(((ImageView)findViewById(imageView)));
...
//    }
    ...
    private void onUploadResultIntent(Intent intent) {
        ...
        Log.d(TAG, "onUploadResultIntent:mDownloadUrl:" + mDownloadUrl);
...
//            ((ImageView)findViewById(imageView)).setImageBitmap(pickResult.getBitmap());
            mFileUri = pickResult.getUri();
            Log.d("ttt", mFileUri+"");
            uploadFromUri(mFileUri);
