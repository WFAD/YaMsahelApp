...
public abstract class PostListFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mManger.setReverseLayout(true);
        mManger.setStackFromEnd(true);
        ...
        mAdapter = new FirebaseRecyclerAdapter
                ...
                postsQuery) {
            // this is an Implementation of the Adapter as A anoumnys class
            @Override
            protected void populateViewHolder(PostViewHolder viewHolder, final Post model, int position) {
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        // Launch CommPostDetailActivity
                        Intent intent = new Intent(getActivity(), CommPostDetailActivity.class);
...
//                 Bind Post to ViewHolder, setting OnClickListener for the star button
                viewHolder.bindToPost(model, new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        // Run two transactions // BUT WHY DO THIS TWO
...
//        MyFirebaseRecyclerAdapter adapter = new MyFirebaseRecyclerAdapter(Post.class,
//                R.layout.item_post,
//                PostViewHolder.class,
//                postsQuery);
