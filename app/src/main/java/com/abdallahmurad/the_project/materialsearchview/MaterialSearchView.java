package com.abdallahmurad.the_project.materialsearchview;
...
import com.abdallahmurad.the_project.materialsearchview.utils.AnimationUtil;
...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    public void setSuggestions(String[] suggestions) {
        if (suggestions != null && suggestions.length > 0) {
            ...
            final com.miguelcatalan.materialsearchview.SearchAdapter adapter = new com.miguelcatalan.materialsearchview.SearchAdapter(mContext, suggestions, suggestionIcon, ellipsize);
            setAdapter(adapter);
